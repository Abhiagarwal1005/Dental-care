...
const HeroSection = () => {
    const word = 'Trusted Dental & Facial Aesthetic Solutions in Gurgaon';
    return (
                    ...
                    <div className="grid max-w-lg grid-cols-1 mx-auto lg:max-w-full lg:items-center lg:grid-cols-2 gap-y-12 lg:gap-x-16">
                        <div className="text-center lg:text-left">
                            <h1 className="text-4xl font-bold leading-tight text-textPrimary sm:text-5xl sm:leading-tight lg:leading-16 lg:text-[55px]">
                                <TextGenerateEffect className='text-4xl font-bold leading-tight text-textPrimary sm:text-5xl sm:leading-tight lg:leading-16 lg:text-[55px]' words={word}/>
                            </h1>
